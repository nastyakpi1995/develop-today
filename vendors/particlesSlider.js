...
export default function ParticleSlider(t) {
    debugger
    var e = this;
    ...
    function r(t, e, i) {
        return _t(e) ? wt.grep(t, function(t, n) {
    ...
    function l(t) {
        var e = {};
        return wt.each(t.match(Ot) || [], function(t, i) {
            e[i] = !0
        }), e
    }
    ...
    function u(t, e, i, n) {
        var s;
        try {
            t && _t(s = t.promise) ? s.call(t).done(e).fail(i) : t && _t(s = t.then) ? s.call(t, e, i) : e.apply(void 0, [t].slice(n))
        } catch (t) {
            i.apply(void 0, [t])
        }
    }
    ...
    function d() {
        rt.removeEventListener("DOMContentLoaded", d), t.removeEventListener("load", d), wt.ready()
    }
    ...
    function f(t) {
        return t.replace(zt, "ms-").replace(Ht, p)
    }

    function m() {
        this.expando = wt.expando + m.uid++
    }
    ...
    function b(t, e) {
        for (var i, n, s = [], o = 0, r = t.length; o < r; o++)(n = t[o]).style && (i = n.style.display, e ? ("none" === i && (s[o] = Rt.get(n, "display") || null, s[o] || (n.style.display = "")), "" === n.style.display && Xt(n) && (s[o] = y(n))) : "none" !== i && (s[o] = "none", Rt.set(n, "display", i)));
    ...
    function w(t, e) {
        var i;
        return i = "undefined" != typeof t.getElementsByTagName ? t.getElementsByTagName(e || "*") : "undefined" != typeof t.querySelectorAll ? t.querySelectorAll(e || "*") : [], void 0 === e || e && o(t, e) ? wt.merge([t], i) : i
    }
        ...
        for (var r, a, l, h, c, u, d = e.createDocumentFragment(), p = [], f = 0, m = t.length; f < m; f++)
            if ((r = t[f]) || 0 === r)
                if ("object" === n(r)) wt.merge(p, r.nodeType ? [r] : r);
                    ...
                    for (a = a || d.appendChild(e.createElement("div")), l = (Kt.exec(r) || ["", ""])[1].toLowerCase(), h = Zt[l] || Zt._default, a.innerHTML = h[1] + wt.htmlPrefilter(r) + h[2], u = h[0]; u--;) a = a.lastChild;
    ...
    function P(t, e, i, n, s, o) {
        var r, a;
        if ("object" == typeof e) {
            for (a in "string" != typeof i && (n = n || i, i = void 0), e) P(t, a, i, n, e[a], o);
            return t
        }
        ...
        return 1 === o && (r = s, (s = function(t) {
            ...
            wt.event.add(this, e, s, n, i)
        })
    }

    function D(t, e) {
        return o(t, "table") && o(11 !== e.nodeType ? e : e.firstChild, "tr") && wt(t).children("tbody")[0] || t
    }
    ...
    function $(t, e, i) {
        for (var n, s = e ? wt.filter(e, t) : t, o = 0; null != (n = s[o]); o++) i || 1 !== n.nodeType || wt.cleanData(w(n)), n.parentNode && (i && wt.contains(n.ownerDocument, n) && x(w(n, "script")), n.parentNode.removeChild(n));
        return t
    }

    function N(t, e, i) {
        var n, s, o, r, a = t.style;
        return (i = i || he(t)) && ("" !== (r = i.getPropertyValue(e) || i[e]) || wt.contains(t.ownerDocument, t) || (r = wt.style(t, e)), !vt.pixelBoxStyles() && le.test(r) && ce.test(e) && (n = a.width, s = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = r, r = i.width, a.width = n, a.minWidth = s, a.maxWidth = o)), void 0 !== r ? r + "" : r
    }
    ...
    function B() {
        _e && (!1 === rt.hidden && t.requestAnimationFrame ? t.requestAnimationFrame(B) : t.setTimeout(B, wt.fx.interval), wt.fx.tick())
    }
    ...
    function X(t, e, i) {
        for (var n, s = (G.tweeners[e] || []).concat(G.tweeners["*"]), o = 0, r = s.length; o < r; o++)
    ...
    function U(t, e, i) {
        var n, s, o, r, a, l, h, c, u = "width" in e || "height" in e,
            ...
            m = t.nodeType && Xt(t),
            g = Rt.get(t, "fxshow");
        for (n in i.queue || (null == (r = wt._queueHooks(t, "fx")).unqueued && (r.unqueued = 0, a = r.empty.fire, r.empty.fire = function() {
            r.unqueued || a()
            ...
            for (n in u && 1 === t.nodeType && (i.overflow = [f.overflow, f.overflowX, f.overflowY], null == (h = g && g.display) && (h = Rt.get(t, "display")), "none" === (c = wt.css(t, "display")) && (h ? c = h : (b([t], !0), h = t.style.display || h, c = wt.css(t, "display"), b([t]))), ("inline" === c || "inline-block" === c && null != h) && "none" === wt.css(t, "float") && (l || (d.done(function() {
                f.display = h
            }), null == h && (c = f.display, h = "none" === c ? "" : c)), f.display = "inline-block")), i.overflow && (f.overflow = "hidden", d.always(function() {
                f.overflow = i.overflow[0], f.overflowX = i.overflow[1], f.overflowY = i.overflow[2]
            })), l = !1, p) l || (g ? "hidden" in g && (m = g.hidden) : g = Rt.access(t, "fxshow", {
                display: h
            }), o && (g.hidden = !m), m && b([t], !0), d.done(function() {
                for (n in m || b([t]), Rt.remove(t, "fxshow"), p) wt.style(t, n, p[n])
    ...
    function G(t, e, i) {
        var n, s, o = 0,
            ...
            h = a.promise({
                ...
                createTween: function(e, i) {
                    var n = wt.Tween(t, h.opts, e, i, h.opts.specialEasing[e] || h.opts.easing);
        ...
        for (V(c, h.opts.specialEasing); o < r; o++)
            if (n = G.prefilters[o].call(h, t, c, h.opts)) return _t(n.stop) && (wt._queueHooks(h.elem, h.opts.queue).stop = n.stop.bind(n)), n;
        return wt.map(c, X, h), _t(h.opts.start) && h.opts.start.call(t, h), h.progress(h.opts.progress).done(h.opts.done, h.opts.complete).fail(h.opts.fail).always(h.opts.always), wt.fx.timer(wt.extend(l, {
            elem: t,
            anim: h,
            queue: h.opts.queue
        })), h
    ...
    function J(t, e, i, s) {
        ...
        if (Array.isArray(e)) wt.each(e, function(e, n) {
            i || Ie.test(t) ? s(t, n) : J(t + "[" + ("object" == typeof n && null != n ? e : "") + "]", n, i, s)
        });
    ...
    function et(t, e, i, n) {
        function s(a) {
            var l;
            return o[a] = !0, wt.each(t[a] || [], function(t, a) {
                var h = a(e, i, n);
    ...
    function it(t, e) {
        var i, n, s = wt.ajaxSettings.flatOptions || {};
    ...
    wt.fn = wt.prototype = {
        ...
        makeArray: function(t, e) {
            var i = e || [];
            return null != t && (s(Object(t)) ? wt.merge(i, "string" == typeof t ? [t] : t) : ct.call(i, t)), i
        },
    ...
    var Tt = function(t) {
                    ...
                    for (; e = e[n];)
                        if (1 === e.nodeType || r)
                            if (c = (u = e[F] || (e[F] = {}))[e.uniqueID] || (u[e.uniqueID] = {}), s && s === e.nodeName.toLowerCase()) e = e[n] || e;
                                ...
                                if ((h = c[o]) && h[0] === j && h[1] === a) return d[2] = h[2];
        ...
        for (w in x = e.support = {}, C = e.isXML = function(t) {
            ...
            return n !== E && 9 === n.nodeType && n.documentElement ? ($ = (E = n).documentElement, N = !C(E), W !== E && (i = E.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", Tt, !1) : i.attachEvent && i.attachEvent("onunload", Tt)), x.attributes = s(function(t) {
            ...
            })), (x.matchesSelector = gt.test(L = $.matches || $.webkitMatchesSelector || $.mozMatchesSelector || $.oMatchesSelector || $.msMatchesSelector)) && s(function(t) {
                x.disconnectedMatch = L.call(t, "*"), L.call(t, "[s!='']:x"), H.push("!=", ot)
            }), z = z.length && new RegExp(z.join("|")), H = H.length && new RegExp(H.join("|")), e = gt.test($.compareDocumentPosition), R = e || gt.test($.contains) ? function(t, e) {
                ...
                return i || (1 & (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !x.sortDetached && e.compareDocumentPosition(t) === i ? t === E || t.ownerDocument === W && R(W, t) ? -1 : e === E || e.ownerDocument === W && R(W, e) ? 1 : M ? tt(M, t) - tt(M, e) : 0 : 4 & i ? -1 : 1)
            } : function(t, e) {
                if (t === e) return I = !0, 0;
                var i, n = 0,
                    s = t.parentNode,
            ...
            if ((t.ownerDocument || t) !== E && O(t), i = i.replace(ct, "='$1']"), x.matchesSelector && N && !X[i + " "] && (!H || !H.test(i)) && (!z || !z.test(i))) try {
                var n = L.call(t, i);
            ...
            var e, i = [],
                n = 0,
                s = 0;
            if (I = !x.detectDuplicates, M = !x.sortStable && t.slice(0), t.sort(U), I) {
        ...
        return d.prototype = T.filters = T.pseudos, T.setFilters = new d, S = e.tokenize = function(t, i) {
            ...
            for (a = t, l = [], h = T.preFilter; a;) {
                for (r in n && !(s = lt.exec(a)) || (s && (a = a.slice(s[0].length) || a), l.push(o = [])), n = !1, (s = ht.exec(a)) && (n = s.shift(), o.push({
                    value: n,
                    type: s[0].replace(at, " ")
                }), a = a.slice(n.length)), T.filter) !(s = pt[r].exec(a)) || h[r] && !(s = h[r](s)) || (n = s.shift(), o.push({
                    value: n,
                    type: r,
                    matches: s
                }), a = a.slice(n.length));
        ...
        }, x.sortStable = F.split("").sort(U).join("") === F, x.detectDuplicates = !!I, O(), x.sortDetached = s(function(t) {
    ...
    wt.filter = function(t, e, i) {
        ...
        is: function(t) {
            return !!r(this, "string" == typeof t && St.test(t) ? wt(t) : t || [], !1).length
        }
    });
    var Dt, At = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    ...
    wt.fn.extend({
        ...
        contents: function(t) {
            return o(t, "iframe") ? t.contentDocument : (o(t, "template") && (t = t.content || t), wt.merge([], t.childNodes))
        }
    }, function(t, e) {
        wt.fn[t] = function(i, n) {
            var s = wt.map(this, e, i);
            return "Until" !== t.slice(-5) && (n = i), n && "string" == typeof n && (s = wt.filter(n, s)), this.length > 1 && (It[t] || wt.uniqueSort(s), Mt.test(t) && s.reverse()), this.pushStack(s)
        }
    });
    var Ot = /[^\x20\t\r\n\f]+/g;
            ...
            u = {
                add: function() {
                    return r && (i && !e && (h = r.length - 1, a.push(i)), function s(e) {
                        wt.each(e, function(e, i) {
                            _t(i) ? t.unique && u.has(i) || r.push(i) : i && i.length && "string" !== n(i) && s(i)
                        })
                ...
                fireWith: function(t, i) {
                    return o || (i = [t, (i = i || []).slice ? i.slice() : i], a.push(i), e || c()), this
                },
                fire: function() {
                ...
                s = {
                    ...
                    then: function(e, n, s) {
                                ...
                                var a = this,
                                    ...
                                    d = s ? u : function() {
                                        try {
                                            ...
                                            wt.Deferred.exceptionHook && wt.Deferred.exceptionHook(t, d.stackTrace), e + 1 >= r && (n !== c && (a = void 0, l = [t]), i.rejectWith(a, l))
                                        }
                                    };
                        ...
                        return wt.Deferred(function(t) {
                            i[0][3].add(o(0, t, _t(s) ? s : h, t.notifyWith)), i[1][3].add(o(0, t, _t(e) ? e : h)), i[2][3].add(o(0, t, _t(n) ? n : c))
                        }).promise()
                    },
                    promise: function(t) {
    ...
    var Nt = function(t, e, i, s, o, r, a) {
            ...
            else if (void 0 !== s && (o = !0, _t(s) || (a = !0), c && (a ? (e.call(t, s), e = null) : (c = e, e = function(t, e, i) {
                return c.call(wt(t), i)
            })), e))
    ...
    m.uid = 1, m.prototype = {
        ...
        remove: function(t, e) {
            ...
            if (void 0 !== n) {
                if (void 0 !== e) {
                    i = (e = Array.isArray(e) ? e.map(f) : (e = f(e)) in n ? [e] : e.match(Ot) || []).length;
                    for (; i--;) delete n[e[i]]
    ...
    wt.extend({
        hasData: function(t) {
            return Ft.hasData(t) || Rt.hasData(t)
        },
        data: function(t, e, i) {
        ...
        data: function(t, e) {
            ...
            return "object" == typeof t ? this.each(function() {
                ...
                var i;
                if (o && void 0 === e) {
                    if (void 0 !== (i = Ft.get(o, t))) return i;
        ...
        queue: function(t, e, i) {
            var n;
            if (t) return e = (e || "fx") + "queue", n = Rt.get(t, e), i && (!n || Array.isArray(i) ? n = Rt.access(t, e, wt.makeArray(i)) : n.push(i)), n || []
        },
    ...
    wt.event = {
        ...
        add: function(t, e, i, n, s) {
            ...
            if (g)
                for (i.handler && (i = (o = i).handler, s = o.selector), s && wt.find.matchesSelector(te, s), i.guid || (i.guid = wt.guid++), (l = g.events) || (l = g.events = {}), (r = g.handle) || (r = g.handle = function(e) {
                    return void 0 !== wt && wt.event.triggered !== e.type ? wt.event.dispatch.apply(t, arguments) : void 0
                }), h = (e = (e || "").match(Ot) || [""]).length; h--;) p = m = (a = ne.exec(e[h]) || [])[1], f = (a[2] || "").split(".").sort(), p && (u = wt.event.special[p] || {}, p = (s ? u.delegateType : u.bindType) || p, u = wt.event.special[p] || {}, c = wt.extend({
                    type: p,
                    origType: m,
                    data: n,
                    handler: i,
                    guid: i.guid,
                    selector: s,
                    needsContext: s && wt.expr.match.needsContext.test(s),
                    namespace: f.join(".")
                }, o), (d = l[p]) || ((d = l[p] = []).delegateCount = 0, u.setup && !1 !== u.setup.call(t, n, f, r) || t.addEventListener && t.addEventListener(p, r)), u.add && (u.add.call(t, c), c.handler.guid || (c.handler.guid = i.guid)), s ? d.splice(d.delegateCount++, 0, c) : d.push(c), wt.event.global[p] = !0)
        },
    ...
    wt.extend({
        ...
        html: function(t) {
            return Nt(this, function(t) {
                ...
                if ("string" == typeof t && !oe.test(t) && !Zt[(Kt.exec(t) || ["", ""])[1].toLowerCase()]) {
        ...
        wt.fn[t] = function(t) {
            for (var i, n = [], s = wt(t), o = s.length - 1, r = 0; r <= o; r++) i = r === o ? this : this.clone(!0), wt(s[r])[e](i), ct.apply(n, i.get());
    ...
    ! function() {
        ...
        h.style && (h.style.backgroundClip = "content-box", h.cloneNode(!0).style.backgroundClip = "", vt.clearCloneStyle = "content-box" === h.style.backgroundClip, wt.extend(vt, {
    ...
    wt.extend({
        ...
        css: function(t, e, i, n) {
            var s, o, r, a = f(e);
            return de.test(e) || (e = L(a)), (r = wt.cssHooks[e] || wt.cssHooks[a]) && "get" in r && (s = r.get(t, !0, i)), void 0 === s && (s = N(t, e, n)), "normal" === s && e in fe && (s = fe[e]), "" === i || i ? (o = parseFloat(s), !0 === i || isFinite(o) ? o || 0 : s) : s
        }
    }), wt.each(["height", "width"], function(t, e) {
        wt.cssHooks[e] = {
            get: function(t, i, n) {
                if (i) return !ue.test(wt.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? W(t, e, n) : Ut(t, pe, function() {
                    return W(t, e, n)
                })
            },
            set: function(t, i, n) {
    ...
    }), wt.cssHooks.marginLeft = z(vt.reliableMarginLeft, function(t, e) {
        if (e) return (parseFloat(N(t, "marginLeft")) || t.getBoundingClientRect().left - Ut(t, {
            marginLeft: 0
        }, function() {
        ...
        wt.cssHooks[t + e] = {
            expand: function(i) {
                for (var n = 0, s = {}, o = "string" == typeof i ? i.split(" ") : [i]; n < 4; n++) s[t + Yt[n] + e] = o[n] || o[n - 2] || o[0];
                return s
            }
        }, "margin" !== t && (wt.cssHooks[t + e].set = R)
    }), wt.fn.extend({
        css: function(t, e) {
            return Nt(this, function(t, e, i) {
                var n, s, o = {},
                    r = 0;
                if (Array.isArray(e)) {
                    for (n = he(t), s = e.length; r < s; r++) o[e[r]] = wt.css(t, e[r], !1, n);
                    return o
                }
        ...
        init: function(t, e, i, n, s, o) {
            this.elem = t, this.prop = i, this.easing = s || wt.easing._default, this.options = e, this.start = this.now = this.cur(), this.end = n, this.unit = o || (wt.cssNumber[i] ? "" : "px")
        },
        cur: function() {
        ...
        _default: "swing"
    }, wt.fx = j.prototype.init, wt.fx.step = {};
    var ve, _e, ye = /^(?:toggle|show|hide)$/,
        be = /queueHooks$/;
    wt.Animation = wt.extend(G, {
        tweeners: {
            "*": [function(t, e) {
        ...
        return wt.fx.off ? n.duration = 0 : "number" != typeof n.duration && (n.duration in wt.fx.speeds ? n.duration = wt.fx.speeds[n.duration] : n.duration = wt.fx.speeds._default), null != n.queue && !0 !== n.queue || (n.queue = "fx"), n.old = n.complete, n.complete = function() {
            _t(n.old) && n.old.call(this), n.queue && wt.dequeue(this, n.queue)
        }, n
    }, wt.fn.extend({
    ...
    wt.fn.extend({
        attr: function(t, e) {
            return Nt(this, wt.attr, t, e, arguments.length > 1)
        },
    ...
    wt.fn.extend({
        prop: function(t, e) {
            return Nt(this, wt.prop, t, e, arguments.length > 1)
        },
        ...
        prop: function(t, e, i) {
            var n, s, o = t.nodeType;
            if (3 !== o && 8 !== o && 2 !== o) return 1 === o && wt.isXMLDoc(t) || (e = wt.propFix[e] || e, s = wt.propHooks[e]), void 0 !== i ? s && "set" in s && void 0 !== (n = s.set(t, i, e)) ? n : t[e] = i : s && "get" in s && null !== (n = s.get(t, e)) ? n : t[e]
        },
        propHooks: {
            tabIndex: {
                get: function(t) {
        ...
        addClass: function(t) {
            ...
            if ((e = Z(t)).length)
                for (; i = this[l++];)
                    if (s = Q(i), n = 1 === i.nodeType && " " + K(s) + " ") {
                        for (r = 0; o = e[r++];) n.indexOf(" " + o + " ") < 0 && (n += o + " ");
                        s !== (a = K(n)) && i.setAttribute("class", a)
                    } return this
        },
        ...
        toggleClass: function(t, e) {
            ...
            return "boolean" == typeof e && n ? e ? this.addClass(t) : this.removeClass(t) : _t(t) ? this.each(function(i) {
                wt(this).toggleClass(t.call(this, i, Q(this), e), e)
            }) : this.each(function() {
                var e, s, o, r;
                if (n)
    ...
    wt.fn.extend({
        val: function(t) {
            ...
            return arguments.length ? (n = _t(t), this.each(function(i) {
                var s;
                1 === this.nodeType && (null == (s = n ? t.call(this, i, wt(this).val()) : t) ? s = "" : "number" == typeof s ? s += "" : Array.isArray(s) && (s = wt.map(s, function(t) {
                    return null == t ? "" : t + ""
                })), (e = wt.valHooks[this.type] || wt.valHooks[this.nodeName.toLowerCase()]) && "set" in e && void 0 !== e.set(this, s, "value") || (this.value = s))
        ...
        valHooks: {
            ...
            select: {
                ...
                set: function(t, e) {
                    for (var i, n, s = t.options, o = wt.makeArray(e), r = s.length; r--;)((n = s[r]).selected = wt.inArray(wt.valHooks.option.get(n), o) > -1) && (i = !0);
    ...
    wt.param = function(t, e) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var t = this.type;
                return this.name && !wt(this).is(":disabled") && $e.test(this.nodeName) && !Ee.test(t) && (this.checked || !Gt.test(t))
            }).map(function(t, e) {
                var i = wt(this).val();
    ...
    Ye.href = De.href, wt.extend({
        ...
        ajax: function(e, i) {
            ...
            if (v.promise(T), f.url = ((e || f.url || De.href) + "").replace(We, De.protocol + "//"), f.type = i.method || i.type || f.method || f.type, f.dataTypes = (f.dataType || "*").toLowerCase().match(Ot) || [""], null == f.crossDomain) {
                h = rt.createElement("a");
                try {
        ...
        wt[e] = function(t, i, n, s) {
            return _t(i) && (s = s || n, n = i, i = void 0), wt.ajax(wt.extend({
                url: t,
                type: e,
                dataType: s,
                data: i,
        ...
        wrapAll: function(t) {
            var e;
            return this[0] && (_t(t) && (t = t.call(this[0])), e = wt(t, this[0].ownerDocument).eq(0).clone(!0), this[0].parentNode && e.insertBefore(this[0]), e.map(function() {
    ...
    vt.cors = !!Ue && "withCredentials" in Ue, vt.ajax = Ue = !!Ue, wt.ajaxTransport(function(e) {
        ...
        if (vt.cors || Ue && !e.crossDomain) return {
            send: function(s, o) {
                ...
                i = function(t) {
                    return function() {
                        i && (i = n = a.onload = a.onerror = a.onabort = a.ontimeout = a.onreadystatechange = null, "abort" === t ? a.abort() : "error" === t ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o(Xe[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                            binary: a.response
                        } : {
                            text: a.responseText
    ...
    wt.ajaxSetup({
        ...
        jsonpCallback: function() {
            var t = Ve.pop() || wt.expando + "_" + Ae++;
            return this[t] = !0, t
        }
    }), wt.ajaxPrefilter("json jsonp", function(e, i, n) {
        var s, o, r, a = !1 !== e.jsonp && (Ge.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && Ge.test(e.data) && "data");
        if (a || "jsonp" === e.dataTypes[0]) return s = e.jsonpCallback = _t(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Ge, "$1" + s) : !1 !== e.jsonp && (e.url += (Me.test(e.url) ? "&" : "?") + e.jsonp + "=" + s), e.converters["script json"] = function() {
            return r || wt.error(s + " was not called"), r[0]
        }, e.dataTypes[0] = "json", o = t[s], t[s] = function() {
            r = arguments
        }, n.always(function() {
            void 0 === o ? wt(t).removeProp(s) : t[s] = o, e[s] && (e.jsonpCallback = i.jsonpCallback, Ve.push(s)), r && _t(o) && o(r[0]), r = o = void 0
        }), "script"
    }), vt.createHTMLDocument = function() {
        var t = rt.implementation.createHTMLDocument("").body;
        return t.innerHTML = "<form></form><form></form>", 2 === t.childNodes.length
    }(), wt.parseHTML = function(t, e, i) {
        return "string" != typeof t ? [] : ("boolean" == typeof e && (i = e, e = !1), e || (vt.createHTMLDocument ? ((n = (e = rt.implementation.createHTMLDocument("")).createElement("base")).href = rt.location.href, e.head.appendChild(n)) : e = rt), o = !i && [], (s = Pt.exec(t)) ? [e.createElement(s[1])] : (s = T([t], e, o), o && o.length && wt(o).remove(), wt.merge([], s.childNodes)));
        var n, s, o
    }, wt.fn.load = function(t, e, i) {
        var n, s, o, r = this,
            a = t.indexOf(" ");
        return a > -1 && (n = K(t.slice(a)), t = t.slice(0, a)), _t(e) ? (i = e, e = void 0) : e && "object" == typeof e && (s = "POST"), r.length > 0 && wt.ajax({
            url: t,
            type: s || "GET",
            dataType: "html",
            data: e
        }).done(function(t) {
            o = arguments, r.html(n ? wt("<div>").append(wt.parseHTML(t)).find(n) : t)
        ...
        position: function() {
            if (this[0]) {
                ...
                return {
                    top: e.top - s.top - wt.css(n, "marginTop", !0),
                    left: e.left - s.left - wt.css(n, "marginLeft", !0)
                }
            }
        },
        ...
        wt.cssHooks[e] = z(vt.pixelPosition, function(t, i) {
            if (i) return i = N(t, e), le.test(i) ? wt(t).position()[e] + "px" : i
        })
    }), wt.each({
        Height: "height",
        Width: "width"
        ...
        wt.each({
            ...
            wt.fn[n] = function(s, o) {
                ...
                return Nt(this, function(e, i, s) {
                    var o;
                    return yt(e) ? 0 === n.indexOf("outer") ? e["inner" + t] : e.document.documentElement["client" + t] : 9 === e.nodeType ? (o = e.documentElement, Math.max(e.body["scroll" + t], o["scroll" + t], e.body["offset" + t], o["offset" + t], o["client" + t])) : void 0 === s ? wt.css(e, i, a) : wt.style(e, i, s, a)
                }, e, r ? s : void 0, r)
            }
        })
        ...
        var i, n, s;
        if ("string" == typeof e && (i = t[e], e = t, t = i), _t(t)) return n = lt.call(arguments, 2), (s = function() {
            return t.apply(e || this, n.concat(lt.call(arguments)))
        }).guid = t.guid = t.guid || wt.guid++, s
    }, wt.holdReady = function(t) {
        t ? wt.readyWait++ : wt.ready(!0)
    }, wt.isArray = Array.isArray, wt.parseJSON = JSON.parse, wt.nodeName = o, wt.isFunction = _t, wt.isWindow = yt, wt.camelCase = f, wt.type = n, wt.now = Date.now, wt.isNumeric = function(t) {
        var e = wt.type(t);
    ...
    return wt.noConflict = function(e) {
        return t.$ === wt && (t.$ = Qe), e && t.jQuery === wt && (t.jQuery = Ke), wt
    }, e || (t.jQuery = t.$ = wt), wt
}),
    ...
    function(t) {
            ...
            function() {
                ...
                t.position = {
                    ...
                    return v = n(_), _[0].preventDefault && (s.at = "left top"), p = v.width, f = v.height, m = v.offset, g = t.extend({}, m), t.each(["my", "at"], function() {
                        ...
                        "right" === s.my[0] ? C.left -= h : "center" === s.my[0] && (C.left -= h / 2), "bottom" === s.my[1] ? C.top -= c : "center" === s.my[1] && (C.top -= c / 2), C.left += S[0], C.top += S[1], n = {
                            marginLeft: d,
                            marginTop: v
        ...
        t.effects = {
                ...
                p.style.cssText = "background-color:rgba(1,1,1,.5)", d.rgba = p.style.backgroundColor.indexOf("rgba") > -1, f(c, function(t, e) {
                    ...
                    parse: function(s, r, a, l) {
                        ...
                        return r !== e && (s = [s, r, a, l], d = "array"), "string" === d ? this.parse(n(s) || o._default) : "array" === d ? (f(c.rgba.props, function(t, e) {
                            p[e.idx] = i(s[e.idx], e)
                        }), this) : "object" === d ? (f(c, s instanceof h ? function(t, e) {
            ...
            function() {
                ...
                t.expr && t.expr.filters && t.expr.filters.animated && (t.expr.filters.animated = function(e) {
                    ...
                    save: function(t, e) {
                        for (var i = 0, n = e.length; n > i; i++) null !== e[i] && t.data(c + e[i], t[0].style[e[i]])
                    },
                    restore: function(t, e) {
                        for (var i, n = 0, s = e.length; s > n; n++) null !== e[n] && (i = t.data(c + e[n]), t.css(e[n], i))
                    },
                    ...
                    effect: function() {
                        function i(e) {
                            function i() {
                                a.removeData(d), t.effects.cleanUp(a), "hide" === n.mode && a.hide(), r()
                            }
        ...
        t.effects.define("blind", "hide", function(e, i) {
            ...
            for (t.effects.createPlaceholder(r), o = r.css(g), u || (u = r["top" === g ? "outerHeight" : "outerWidth"]() / 3), h && ((s = {
                opacity: 1
            })[g] = o, r.css("opacity", 0).css(g, v ? 2 * -u : 2 * u).animate(s, f, m)), l && (u /= Math.pow(2, d - 1)), (s = {})[g] = o; d > _; _++)(n = {})[g] = (v ? "-=" : "+=") + u, r.animate(n, f, m).animate(s, f, m), u = l ? 2 * u : u / 2;
            l && ((n = {
                opacity: 0
            })[g] = (v ? "-=" : "+=") + u, r.animate(n, f, m)), r.queue(i), t.effects.unshift(r, y, p + 1)
            ...
            var o, r, a, l, h, c, u = e.pieces ? Math.round(Math.sqrt(e.pieces)) : 3,
                ...
                _ = [];
            for (o = 0; u > o; o++)
                for (l = m.top + o * v, c = o - (u - 1) / 2, r = 0; d > r; r++) a = m.left + r * g, h = r - (d - 1) / 2, p.clone().appendTo("body").wrap("<div></div>").css({
                    position: "absolute",
                    visibility: "visible",
                    left: -r * g,
                    top: -o * v
            ...
            var n = t(this),
                ...
                m = [d[h[0]], d[h[1]]],
                g = n.queue().length;
            l && (a = parseInt(l[1], 10) / 100 * m[r ? 0 : 1]), p.clip[h[0]] = a, f.clip[h[0]] = a, f.clip[h[1]] = 0, o && (n.cssClip(f.clip), u && u.css(t.effects.clipToBox(f)), f.clip = d), n.queue(function(i) {
        ...
        t.widget("ui.controlgroup", {
            ...
            _optionDatepicker: function(e, i, n) {
                ...
                return 2 === arguments.length && "string" == typeof i ? "defaults" === i ? t.extend({}, t.datepicker._defaults) : h ? "all" === i ? t.extend({}, h.settings) : this._get(h, i) : null : (s = i || {}, "string" == typeof i && ((s = {})[i] = n), void(h && (this._curInst === h && this._hideDatepicker(), o = this._getDateDatepicker(e, !0), a = this._getMinMaxDate(h, "min"), l = this._getMinMaxDate(h, "max"), r(h.settings, s), null !== a && void 0 !== s.dateFormat && void 0 === s.minDate && (h.settings.minDate = this._formatDate(h, a)), null !== l && void 0 !== s.dateFormat && void 0 === s.maxDate && (h.settings.maxDate = this._formatDate(h, l)), "disabled" in s && (s.disabled ? this._disableDatepicker(e) : this._enableDatepicker(e)), this._attachments(t(e), h), this._autoSize(h), this._setDate(h, o), this._updateAlternate(h), this._updateDatepicker(h))))
            },
            ...
            _generateHTML: function(t) {
                ...
                for (t.drawMonth = J, t.drawYear = tt, i = this._get(t, "prevText"), i = Y ? this.formatDate(i, this._daylightSavingAdjust(new Date(tt, J - V, 1)), this._getFormatConfig(t)) : i, n = this._canAdjustMonth(t, -1, tt, J) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (j ? "e" : "w") + "'>" + i + "</span></a>" : q ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (j ? "e" : "w") + "'>" + i + "</span></a>", s = this._get(t, "nextText"), s = Y ? this.formatDate(s, this._daylightSavingAdjust(new Date(tt, J + V, 1)), this._getFormatConfig(t)) : s, o = this._canAdjustMonth(t, 1, tt, J) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (j ? "w" : "e") + "'>" + s + "</span></a>" : q ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (j ? "w" : "e") + "'>" + s + "</span></a>", r = this._get(t, "currentText"), a = this._get(t, "gotoCurrent") && t.currentDay ? K : W, r = Y ? this.formatDate(r, a, this._getFormatConfig(t)) : r, l = t.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(t, "closeText") + "</button>", h = B ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (j ? l : "") + (this._isInRange(t, a) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + r + "</button>" : "") + (j ? "" : l) + "</div>" : "", c = parseInt(this._get(t, "firstDay"), 10), c = isNaN(c) ? 0 : c, u = this._get(t, "showWeek"), d = this._get(t, "dayNames"), p = this._get(t, "dayNamesMin"), f = this._get(t, "monthNames"), m = this._get(t, "monthNamesShort"), g = this._get(t, "beforeShowDay"), v = this._get(t, "showOtherMonths"), _ = this._get(t, "selectOtherMonths"), y = this._getDefaultDate(t), b = "", x = 0; X[0] > x; x++) {
                    for (T = "", this.maxRows = 4, k = 0; X[1] > k; k++) {
                        if (C = this._daylightSavingAdjust(new Date(tt, J, t.selectedDay)), S = " ui-corner-all", P = "", G) {
                        ...
                        for (P += D + "</tr></thead><tbody>", M = this._getDaysInMonth(tt, J), tt === t.selectedYear && J === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, M)), I = (this._getFirstDayOfMonth(tt, J) - c + 7) % 7, O = Math.ceil((I + M) / 7), E = G && this.maxRows > O ? this.maxRows : O, this.maxRows = E, $ = this._daylightSavingAdjust(new Date(tt, J, 1 - I)), N = 0; E > N; N++) {
                            for (P += "<tr>", z = u ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")($) + "</td>" : "", w = 0; 7 > w; w++) H = g ? g.apply(t.input ? t.input[0] : null, [$]) : [!0, ""], R = (L = $.getMonth() !== J) && !_ || !H[0] || Q && Q > $ || Z && $ > Z, z += "<td class='" + ((w + c + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (L ? " ui-datepicker-other-month" : "") + ($.getTime() === C.getTime() && J === t.selectedMonth && t._keyEvent || y.getTime() === $.getTime() && y.getTime() === C.getTime() ? " " + this._dayOverClass : "") + (R ? " " + this._unselectableClass + " ui-state-disabled" : "") + (L && !v ? "" : " " + H[1] + ($.getTime() === K.getTime() ? " " + this._currentClass : "") + ($.getTime() === W.getTime() ? " ui-datepicker-today" : "")) + "'" + (L && !v || !H[2] ? "" : " title='" + H[2].replace(/'/g, "&#39;") + "'") + (R ? "" : " data-handler='selectDay' data-event='click' data-month='" + $.getMonth() + "' data-year='" + $.getFullYear() + "'") + ">" + (L && !v ? "&#xa0;" : R ? "<span class='ui-state-default'>" + $.getDate() + "</span>" : "<a class='ui-state-default" + ($.getTime() === W.getTime() ? " ui-state-highlight" : "") + ($.getTime() === K.getTime() ? " ui-state-active" : "") + (L ? " ui-priority-secondary" : "") + "' href='#'>" + $.getDate() + "</a>") + "</td>", $.setDate($.getDate() + 1), $ = this._daylightSavingAdjust($);
                            P += z + "</tr>"
                        }++J > 11 && (J = 0, tt++), T += P += "</tbody></table>" + (G ? "</div>" + (X[0] > 0 && k === X[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : "")
                    }
                    b += T
                }
        ...
        t.extend(t.fn, {
            validate: function(e) {
                if (this.length) {
                    ...
                    return i || (this.attr("novalidate", "novalidate"), i = new t.validator(e, this[0]), t.data(this[0], "validator", i), i.settings.onsubmit && (this.on("click.validate", ":submit", function(e) {
                        ...
                        function n() {
                            var n, s;
                            return i.submitButton && (i.settings.submitHandler || i.formSubmitted) && (n = t("<input type='hidden'/>").attr("name", i.submitButton.name).val(t(i.submitButton).val()).appendTo(i.currentForm)), !i.settings.submitHandler || (s = i.settings.submitHandler.call(i, i.currentForm, e), n && n.remove(), void 0 !== s && s)
                        }
            ...
            rules: function(e, i) {
                ...
                if (null != h && (!h.form && h.hasAttribute("contenteditable") && (h.form = this.closest("form")[0], h.name = this.attr("name")), null != h.form)) {
                    ...
                    return (r = t.validator.normalizeRules(t.extend({}, t.validator.classRules(h), t.validator.attributeRules(h), t.validator.dataRules(h), t.validator.staticRules(h)), h)).required && (a = r.required, delete r.required, r = t.extend({
                        required: a
            ...
            methods: {
                ...
                remote: function(e, i, n, s) {
                    ...
                    return this.settings.messages[i.name] || (this.settings.messages[i.name] = {}), l.originalMessage = l.originalMessage || this.settings.messages[i.name][s], this.settings.messages[i.name][s] = l.message, n = "string" == typeof n && {
                        ...
                        data: e
                    }, n.data)), l.old === a ? l.valid : (l.old = a, o = this, this.startRequest(i), (r = {})[i.name] = e, t.ajax(t.extend(!0, {
                        mode: "abort",
                        ...
                        success: function(t) {
                            ...
                            o.settings.messages[i.name][s] = l.originalMessage, h ? (a = o.formSubmitted, o.resetInternals(), o.toHide = o.errorsFor(i), o.formSubmitted = a, o.successList.push(i), o.invalid[i.name] = !1, o.showErrors()) : (n = {}, r = t || o.defaultMessage(i, {
                                method: s,
                                parameters: e
                            }), n[i.name] = l.message = r, o.invalid[i.name] = !0, o.showErrors(n)), l.valid = h, o.stopRequest(i, h)
                        }
                    }, n)), "pending")
                }
            }
    ...
    function(t, e) {
        ...
        t.Controller = function(n) {
            var o, r, a = "ScrollMagic.Controller",
                ...
                x = function() {
                    p.refreshInterval > 0 && (r = window.setTimeout(A, p.refreshInterval))
                },
                T = function() {
                ...
                S = function() {
                    if (b && m) {
                        ...
                        var e = g,
                            i = (g = d.scrollPos()) - e;
                        0 !== i && (v = i > 0 ? l : h), v === h && t.reverse(), t.forEach(function(t) {
                            t.update(!0)
                        })
                    }
                },
                ...
                D = function(t) {
                    "resize" == t.type && (y = k(), v = c), !0 !== m && (m = !0, P())
                },
                A = function() {
                    if (!_ && y != k()) {
                        var t;
            ...
            return this.addScene = function(e) {
                if (s.type.Array(e)) e.forEach(function(t) {
                    ...
                    if (e.controller() !== d) e.addTo(d);
                        ...
                        for (var i in f.push(e), f = M(f), e.on("shift.controller_sort", function() {
                            f = M(f)
                ...
                return s.type.Array(e) ? e.forEach(function(t) {
                    d.updateScene(t, i)
                }) : i ? e.update(!0) : !0 !== m && e instanceof t.Scene && (-1 == (m = m || []).indexOf(e) && m.push(e), m = M(m), P()), d
                ...
                return p.container.removeEventListener("resize", D), p.container.removeEventListener("scroll", D), s.cAF(o), null
            }, w(), d
        };
        var i = {
            defaults: {
        ...
        t.Controller.addOption = function(t, e) {
            ...
            this.on = function(t, e) {
                ...
                return e instanceof t.Controller && r != e && (r && r.removeScene(u), r = e, P(), T(!0), k(!0), x(), r.info("container").addEventListener("resize", C), e.addScene(u), u.trigger("add", {
                    controller: r
                }), u.update()), u
            }, this.enabled = function(t) {
            ...
            var b, w, x = function() {
                ...
                T = function(t) {
                    if (o) {
                        var e = "duration";
                        D(e, o.call(u)) && !t && (u.trigger("change", {
                            what: e,
                            newval: d[e]
                        }), u.trigger("shift", {
                            reason: e
                ...
                A = function(t) {
                    u[t] || (u[t] = function(e) {
                        return arguments.length ? ("duration" === t && (o = void 0), D(t, e) && (u.trigger("change", {
                            what: t,
                            newval: d[t]
            ...
            var M = function(t) {
                    if (b && r) {
                        ...
                        if (t || p !== l) {
                            ...
                            c[e.vertical ? "top" : "left"] += u, s.css(w.spacer.firstChild, {
                                top: c.top,
                                left: c.left
                            })
                        }
                ...
                I = function() {
                    if (b && r && w.inFlow) {
                        var t = p === l,
                            ...
                            o = {};
                        w.relSize.width || w.relSize.autoFullWidth ? t ? s.css(b, {
                            width: s.get.width(w.spacer)
                        }) : s.css(b, {
                            width: "100%"
                        }) : (o["min-width"] = s.get.width(e ? b : i, !0, !0), o.width = t ? o["min-width"] : "auto"), w.relSize.height ? t ? s.css(b, {
                            height: s.get.height(w.spacer) - (w.pushFollowers ? d.duration : 0)
                        }) : s.css(b, {
                            height: "100%"
                        }) : (o["min-height"] = s.get.height(e ? i : b, !0, !n), o.height = t ? o["min-height"] : "auto"), w.pushFollowers && (o["padding" + (e ? "Top" : "Left")] = d.duration * f, o["padding" + (e ? "Bottom" : "Right")] = d.duration * (1 - f)), s.css(w.spacer, o)
                    }
                },
                O = function() {
                    r && b && p === l && !r.info("isDocument") && M()
                },
                E = function() {
                    r && b && p === l && ((w.relSize.width || w.relSize.autoFullWidth) && s.get.width(window) != s.get.width(w.spacer.parentNode) || w.relSize.height && s.get.height(window) != s.get.height(w.spacer.parentNode)) && I()
                },
                $ = function(t) {
                    r && b && p === l && !r.info("isDocument") && (t.preventDefault(), r._setScrollPos(r.info("scrollPos") - ((t.wheelDelta || t[r.info("vertical") ? "wheelDeltaY" : "wheelDeltaX"]) / 3 || 30 * -t.detail)))
                };
            this.setPin = function(t, i) {
                ...
                if (a || s.extend(d, s.css(b, ["width", "height"])), s.css(c, d), c.setAttribute(e, ""), s.addClass(c, i.spacerClass), w = {
                    spacer: c,
                    relSize: {
                    ...
                    r.concat(["width", "height", "position", "boxSizing", "mozBoxSizing", "webkitBoxSizing"]).forEach(function(t) {
                        b.___origStyle[t] = p[t] || ""
                    })
                }
                return w.relSize.width && s.css(c, {
                    width: h.width
                }), w.relSize.height && s.css(c, {
                    height: h.height
                }), c.appendChild(b), s.css(b, {
                    position: a ? "relative" : "absolute",
                    margin: "auto",
                    top: "auto",
                    left: "auto",
                ...
                }), window.addEventListener("scroll", O), window.addEventListener("resize", O), window.addEventListener("resize", E), b.addEventListener("mousewheel", $), b.addEventListener("DOMMouseScroll", $), M(), u
            ...
            return u.on("destroy.internal", function(t) {
                ...
                return t && z.forEach(function(t) {
                    s.removeClass(t, N)
                }), u.off("start.internal_class end.internal_class"), N = void 0, z = [], u
            }, _(), u
        };
        var n = {
            defaults: {
        ...
        t.Scene.extend(function() {
            ...
            e.addIndicators = function(i) {
                if (!t) {
                    ...
                    i = s.extend({}, n, i), o++, t = new r(e, i), e.on("add.plugin_addIndicators", t.add), e.on("remove.plugin_addIndicators", t.remove), e.on("destroy.plugin_addIndicators", e.removeIndicators), e.controller() && t.add()
                }
                return e
            ...
            return o.addEventListener("resize", c), r || (window.addEventListener("resize", c), window.addEventListener("scroll", c)), o.addEventListener("resize", h), o.addEventListener("scroll", h), this._indicators.updateBoundsPositions = function(t) {
                for (var e, i, r, h = t ? [s.extend({}, t.triggerGroup, {
                    members: [t]
                })] : l.groups, c = h.length, u = {}, d = a ? "left" : "top", p = a ? "width" : "height", f = a ? s.get.scrollLeft(o) + s.get.width(o) - n : s.get.scrollTop(o) + s.get.height(o) - n; c--;)
                    for (e = (r = h[c]).members.length, i = s.get[p](r.element.firstChild); e--;) u[d] = f - i, s.css(r.members[e].bounds, u)
            }, this._indicators.updateTriggerGroupPositions = function(t) {
                for (var i, h, c, u, d = t ? [t] : l.groups, p = d.length, f = r ? document.body : o, m = r ? {
                    top: 0,
                    left: 0
                } : s.get.offset(f, !0), g = a ? s.get.width(o) - n : s.get.height(o) - n, v = a ? "width" : "height", _ = a ? "Y" : "X"; p--;) h = (i = d[p]).element, u = (c = i.triggerHook * e.info("size")) > s.get[v](h.firstChild.firstChild) ? "translate" + _ + "(-100%)" : "", s.css(h, {
                    top: m.top + (a ? c : g - i.members[0].options.indent),
                    left: m.left + (a ? g - i.members[0].options.indent : c)
                }), s.css(h.firstChild.firstChild, {
                    "-ms-transform": u,
                    "-webkit-transform": u,
                    transform: u
                })
                ...
                i.textContent !== e && (i.textContent = e, a && l.updateBoundsPositions())
                ...
                o.removeEventListener("resize", c), r || (window.removeEventListener("resize", c), window.removeEventListener("scroll", c)), o.removeEventListener("resize", h), o.removeEventListener("scroll", h), this.$super.destroy.apply(this, arguments)
            }, e
        });
        var r = function(t, e) {
                var i, n, r = this,
                    l = a.bounds(),
                    h = a.start(e.colorStart),
                    c = a.end(e.colorEnd),
                    u = e.parent && s.get.elements(e.parent)[0];
                e.name = e.name || o, h.firstChild.textContent += " " + e.name, c.textContent += " " + e.name, l.appendChild(h), l.appendChild(c), r.options = e, r.bounds = l, r.triggerGroup = void 0, this.add = function() {
                    n = t.controller(), i = n.info("vertical");
                    var e = n.info("isDocument");
                    u || (u = e ? document.body : n.info("container")), e || "static" !== s.css(u, "position") || s.css(u, {
                        position: "relative"
                    }), t.on("change.plugin_addIndicators", p), t.on("shift.plugin_addIndicators", d), y(), g(), setTimeout(function() {
                        n._indicators.updateBoundsPositions(r)
                    }, 0)
                }, this.remove = function() {
                    if (r.triggerGroup) {
                        if (t.off("change.plugin_addIndicators", p), t.off("shift.plugin_addIndicators", d), r.triggerGroup.members.length > 1) {
                            var e = r.triggerGroup;
                            e.members.splice(e.members.indexOf(r), 1), n._indicators.updateTriggerGroupLabel(e), n._indicators.updateTriggerGroupPositions(e), r.triggerGroup = void 0
                        } else _();
                        m()
                    }
                };
                var d = function() {
                    ...
                    g = function() {
                        l.parentNode !== u && f();
                        var e = {};
                        e[i ? "top" : "left"] = t.triggerPosition(), e[i ? "height" : "width"] = t.duration(), s.css(l, e), s.css(c, {
                    ...
                    v = function() {
                        var o = a.trigger(e.colorTrigger),
                            l = {};
                        l[i ? "right" : "bottom"] = 0, l[i ? "border-top-width" : "border-left-width"] = 1, s.css(o.firstChild, l), s.css(o.firstChild.firstChild, {
                        ...
                        n._indicators.groups.push(h), r.triggerGroup = h, n._indicators.updateTriggerGroupLabel(h), n._indicators.updateTriggerGroupPositions(h)
                    },
                    _ = function() {
                        n._indicators.groups.splice(n._indicators.groups.indexOf(r.triggerGroup), 1), r.triggerGroup.element.parentNode.removeChild(r.triggerGroup.element), r.triggerGroup = void 0
                    },
                    y = function() {
                        var e = t.triggerHook(),
                            i = 1e-4;
                        if (!(r.triggerGroup && Math.abs(r.triggerGroup.triggerHook - e) < i)) {
                            for (var s, o = n._indicators.groups, a = o.length; a--;)
                                if (s = o[a], Math.abs(s.triggerHook - e) < i) return r.triggerGroup && (1 === r.triggerGroup.members.length ? _() : (r.triggerGroup.members.splice(r.triggerGroup.members.indexOf(r), 1), n._indicators.updateTriggerGroupLabel(r.triggerGroup), n._indicators.updateTriggerGroupPositions(r.triggerGroup))), s.members.push(r), r.triggerGroup = s, void n._indicators.updateTriggerGroupLabel(s);
                            if (r.triggerGroup) {
                                if (1 === r.triggerGroup.members.length) return r.triggerGroup.triggerHook = e, void n._indicators.updateTriggerGroupPositions(r.triggerGroup);
                                r.triggerGroup.members.splice(r.triggerGroup.members.indexOf(r), 1), n._indicators.updateTriggerGroupLabel(r.triggerGroup), n._indicators.updateTriggerGroupPositions(r.triggerGroup), r.triggerGroup = void 0
                            }
                            v()
                        }
                    }
            ...
            a = {
                start: function(t) {
                    ...
                    var e = document.createElement("div");
                    return e.textContent = "end", s.css(e, {
                        position: "absolute",
                        overflow: "visible",
                        "border-width": 0,
                        "border-style": "solid",
    ...
    _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(t, e, i) {
        ...
        o.version = "2.0.2", c.constructor = o, c.kill()._gc = !1, o.killTweensOf = o.killDelayedCallsTo = i.killTweensOf, o.getTweensOf = i.getTweensOf, o.lagSmoothing = i.lagSmoothing, o.ticker = i.ticker, o.render = i.render, c.invalidate = function() {
            ...
            var f, m, g, v, _ = 0,
                y = [],
                b = function() {
                    r.onComplete && r.onComplete.apply(r.onCompleteScope || this, arguments), c.apply(p || r.callbackScope || this, d || u)
                },
                w = r.cycle,
        ...
        return n.version = "2.0.2", g.constructor = n, g.kill()._gc = g._forcingPlayhead = g._hasPause = !1, g.to = function(t, e, n, s) {
            ...
            s = s || -9999999999;
            for (var o = [], r = this._first, a = 0; r;) r._startTime < s || (r instanceof i ? !1 !== e && (o[a++] = r) : (!1 !== n && (o[a++] = r), !1 !== t && (a = (o = o.concat(r.getChildren(!0, e, n))).length))), r = r._next;
            return o
        ...
        set: function(e) {
            ...
            if (this._autoRotate) {
                ...
                for (s = T.length; --s > -1;) o = T[s][2], w = T[s][3] || 0, x = !0 === T[s][4] ? 1 : t, r = this._beziers[T[s][0]], g = this._beziers[T[s][1]], r && g && (r = r[i], g = g[i], v = r.a + (r.b - r.a) * a, v += ((y = r.b + (r.c - r.b) * a) - v) * a, y += (r.c + (r.d - r.c) * a - y) * a, _ = g.a + (g.b - g.a) * a, _ += ((b = g.b + (g.c - g.b) * a) - _) * a, b += (g.c + (g.d - g.c) * a - b) * a, l = m ? Math.atan2(b - _, y - v) * x + w : this._initialRotations[s], this._mod[o] && (l = this._mod[o](l, f)), p[o] ? f[o](l) : f[o] = l)
            }
        }
    }), g = m.prototype, m.bezierThrough = u, m.cubicToQuadratic = l, m._autoCSS = !0, m.quadraticToCubic = function(t, e, i) {
        ...
        h.constructor = r, r.version = "2.0.2", r.API = 2, r.defaultTransformPerspective = 0, r.defaultSkewType = "compensated", r.defaultSmoothOrigin = !0, h = "px", r.suffixMap = {
            top: h,
            right: h,
            bottom: h,
            left: h,
        ...
        var c, u, d, p, f, m, g, v, _ = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
            ...
            Q = function(t, e) {
                ...
                return n >= 0 ? (K = 3 === n ? "ms" : i[n], G = "-" + K.toLowerCase() + "-", K + t) : null
            },
            Z = ("undefined" != typeof window ? window : F.defaultView || {
                getComputedStyle: function() {}
            }).getComputedStyle,
            J = r.getStyle = function(t, e, i, n, s) {
                var o;
                return X || "opacity" !== e ? (!n && t.style[e] ? o = t.style[e] : (i = i || Z(t)) ? o = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(P, "-$1").toLowerCase()) : t.currentStyle && (o = t.currentStyle[e]), null == s || o && "none" !== o && "auto" !== o && "auto auto" !== o ? o : s) : U(t)
            },
            ...
            ct = function(t, e, i, n) {
                ...
                return "function" == typeof t && (t = t(v, g)), null == t ? a = e : "number" == typeof t ? a = t : (s = 360, o = t.split("_"), r = ((l = "=" === t.charAt(1)) ? parseInt(t.charAt(0) + "1", 10) * parseFloat(o[0].substr(2)) : parseFloat(o[0])) * (-1 === t.indexOf("rad") ? 1 : H) - (l ? 0 : e), o.length && (n && (n[i] = e + r), -1 !== t.indexOf("short") && ((r %= s) !== r % (s / 2) && (r = 0 > r ? r + s : r - s)), -1 !== t.indexOf("_cw") && 0 > r ? r = (r + 9999999999 * s) % s - (r / s | 0) * s : -1 !== t.indexOf("ccw") && r > 0 && (r = (r - 9999999999 * s) % s - (r / s | 0) * s)), a = e + r), h > a && a > -h && (a = 0), a
            },
            ut = {
                aqua: [0, 255, 255],
                lime: [0, 255, 0],
                ...
                if (t)
                    if ("number" == typeof t) i = [t >> 16, t >> 8 & 255, 255 & t];
                        ...
                        if ("," === t.charAt(t.length - 1) && (t = t.substr(0, t.length - 1)), ut[t]) i = ut[t];
                            ...
                            } else r = Number(i[0]) % 360 / 360, a = Number(i[1]) / 100, n = 2 * (l = Number(i[2]) / 100) - (s = .5 >= l ? l * (a + 1) : l + a - l * a), i.length > 3 && (i[3] = Number(i[3])), i[0] = dt(r + 1 / 3, n, s), i[1] = dt(r, n, s), i[2] = dt(r - 1 / 3, n, s);
        ...
        var gt = function(t, e, i, n) {
                ...
                return c ? s = e ? function(t) {
                    ...
                    if ("number" == typeof t) t += u;
                        ...
                        for (o = t.replace($, "|").split("|"), d = 0; d < o.length; d++) o[d] = s(o[d]);
                        return o.join(",")
                    }
            ...
            }, q.CSSPropTween = function(t, e, n, s, r, a, l, h, c, u, d) {
                this.t = t, this.p = e, this.s = n, this.c = s, this.n = l || e, t instanceof yt || o.push(this.n), this.r = h ? "function" == typeof h ? h : Math.round : h, this.type = a || 0, c && (this.pr = c, i = !0), this.b = void 0 === u ? n : u, this.e = void 0 === d ? n + s : d, r && (this._next = r, r._prev = this)
            }),
                ...
                if (!l[t]) {
                    ...
                    kt(t, {
                        parser: function(t, i, n, s, o, r, h) {
                            ...
                            return c ? (c._cssRegister(), l[n].parse(t, i, n, s, o, r, h)) : (V("Error: " + e + " js file not loaded."), o)
                        }
                    })
                }
            };
        (h = Tt.prototype).parseComplex = function(t, e, i, n, s, o) {
            ...
            kt(t, {
                parser: function(t, n, s, o, r, a) {
                    var l = new yt(t, s, 0, 0, r, 2, s, !1, i);
        ...
        var St, Pt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
            ...
            zt = function() {
                ...
                return F.createElementNS && !n && (t = $t("svg", Nt), i = (e = $t("rect", t, {
                    width: 100,
                    height: 50,
                    x: 100
                })).getBoundingClientRect().width, e.style[Mt] = "50% 50%", e.style[Dt] = "scaleX(0.5)", n = i === e.getBoundingClientRect().width && !(p && It), Nt.removeChild(t)), n
            }(),
            ...
            Lt = function(t) {
                ...
                } catch (r) {} else this._originalGetBBox && (e = this._originalGetBBox());
            ...
            Ft = function(t) {
                return !(!Et || !t.getCTM || t.parentNode && !t.ownerSVGElement || !Rt(t))
            },
            Wt = [1, 0, 0, 1, 0, 0],
            jt = function(t, e) {
            ...
            Bt = q.getTransform = function(t, i, n, s) {
                ...
                return n && (t._gsTransform = d, d.svg && (St && t.style[Dt] ? e.delayedCall(.001, function() {
                    Ut(t.style, Dt)
        ...
        for (kt("clearProps", {
            parser: function(t, e, n, s, o) {
                return (o = new yt(t, n, 0, 0, o, 2)).setRatio = Gt, o.e = e, o.pr = -10, o.data = s._tween, i = !0, o
            }
        ...
        (h = r.prototype)._firstPT = h._lastParsedTransform = h._transform = null, h._onInitTween = function(t, e, a, h) {
            ...
            for (r in e) {
                if ("function" == typeof(p = e[r]) && (p = p(v, g)), a = l[r]) i = a.parse(t, p, r, this, i, o, e);
                    ...
                    if ("--" === r.substr(0, 2)) {
                        this._tween._propLookup[r] = this._addTween.call(this._tween, t.style, "setProperty", Z(t).getPropertyValue(r) + "", p + "", r, !1, r);
                        continue
                    }
            ...
            this._transform = this._transform || Bt(this._target, s, !0), this._transformType = this._transform.svg && St || !t && 3 !== this._transformType ? 2 : 3
        };
        var Kt = function() {
        ...
        return v.constructor = g, v.getRatio = function(t) {
            ...
            for (h.sort(function(t, e) {
                return t.x - e.x
            }), a = new p(1, 1, null), d = u; --d > -1;) r = h[d], a = new p(r.x, r.y, a);
    ...
    function(t, e) {
        ...
        b("Ticker", function(t, e) {
            ...
            C.call(l), l.time = l.frame = 0, l.tick = function() {
                ...
                null != o && (d && P ? P(o) : clearTimeout(o), s = m, o = null, l === h && (c = !1))
            }, l.wake = function(t) {
                null !== o ? l.sleep() : t ? u += -A + (A = D()) : l.frame > 10 && (A = D() - f + 5), s = 0 === i ? m : d && S ? S : function(t) {
        ...
        (l = E.prototype = new M).constructor = E, l.kill()._gc = !1, l.ratio = 0, l._firstPT = l._targets = l._overwrittenProps = l._startAt = null, l._notifyPluginsOfEnabled = l._lazy = !1, E.version = "2.0.2", E.defaultEase = l._ease = new x(null, null, 1, 1), E.defaultOverwrite = "auto", E.ticker = h, E.autoSleep = 120, E.lagSmoothing = function(t, e) {
            h.lagSmoothing(t, e)
        ...
        var z = [],
            ...
            j = function(t, e, i, n, s, o, r, a, l) {
                ...
                return ("number" != typeof u || "number" != typeof n && !d) && (r || isNaN(u) || !d && isNaN(n) || "boolean" == typeof u || "boolean" == typeof n ? (p.fp = r, p = {
                    t: W(u, d ? parseFloat(p.s) + p.c + (p.s + "").replace(/[0-9\-\.]/g, "") : n, a || E.defaultStringFilter, p),
                    p: "setRatio",
                    s: 0,
                    c: 1,
                    f: 2,
        ...
        K._startTime = h.time, G._startTime = h.frame, K._active = G._active = !0, setTimeout(Z, 1), M._updateRoot = E.render = function() {
            var t, e, i;
            if (z.length && Z(), K.render((h.time - K._startTime) * K._timeScale, !1, !1), G.render((h.frame - G._startTime) * G._timeScale, !1, !1), z.length && Z(), h.frame >= Q) {
                for (i in Q = h.frame + (parseInt(E.autoSleep, 10) || 120), Y) {
                    for (t = (e = Y[i].tweens).length; --t > -1;) e[t]._gc && e.splice(t, 1);
                    0 === e.length && delete Y[i]
                }
                if ((!(i = K._first) || i._paused) && E.autoSleep && !G._first && 1 === h._listeners.tick.length) {
        ...
        l._init = function() {
            ...
            if (r.startAt) {
                ...
                if (this._startAt) this._startAt.render(-1, !0), this._startAt.kill(), this._startAt = null;
                    ...
                    for (n in 0 !== this._time && (h = !1), i = {}, r) U[n] && "autoCSS" !== n || (i[n] = r[n]);
    ...
    function(t, e) {
        ...
        function i(t) {
            ...
            function n() {
                ...
                if (o < n ? "hidden" === s.overflowY && (e("scroll"), i(), o = "content-box" === s.boxSizing ? Math.round(parseFloat(window.getComputedStyle(t, null).height)) : t.offsetHeight) : "hidden" !== s.overflowY && (e("hidden"), i(), o = "content-box" === s.boxSizing ? Math.round(parseFloat(window.getComputedStyle(t, null).height)) : t.offsetHeight), h !== o) {
                    h = o;
            ...
            if (t && t.nodeName && "TEXTAREA" === t.nodeName && !a.has(t)) {
                var s, o = null,
                    ...
                    u = function(e) {
                        window.removeEventListener("resize", c, !1), t.removeEventListener("input", n, !1), t.removeEventListener("keyup", n, !1), t.removeEventListener("autosize:destroy", u, !1), t.removeEventListener("autosize:update", n, !1), Object.keys(e).forEach(function(i) {
                            t.style[i] = e[i]
                        }), a["delete"](t)
                    }.bind(t, {
                ...
                t.addEventListener("autosize:destroy", u, !1), "onpropertychange" in t && "oninput" in t && t.addEventListener("keyup", n, !1), window.addEventListener("resize", c, !1), t.addEventListener("input", n, !1), t.addEventListener("autosize:update", n, !1), t.style.overflowX = "hidden", t.style.wordWrap = "break-word", a.set(t, {
                    destroy: u,
                    update: n
                }), "vertical" === (s = window.getComputedStyle(t, null)).resize ? t.style.resize = "none" : "both" === s.resize && (t.style.resize = "horizontal"), o = "content-box" === s.boxSizing ? -(parseFloat(s.paddingTop) + parseFloat(s.paddingBottom)) : parseFloat(s.borderTopWidth) + parseFloat(s.borderBottomWidth), isNaN(o) && (o = 0), n()
            }
        }
        ...
        var o, r, a = "function" == typeof Map ? new Map : (o = [], r = [], {
                has: function(t) {
...
var AppYalantis, psParticle = function(t) {
...
psParticle.prototype.move = function() {
    ...
    return {
        init: function() {
            t = $("[" + e + '*="' + AppYalantis.Helpers.getBrowserWidth() + '"]'), n()
        },
        lazyLoad: function(t, e) {
            AppYalantis.Helpers.getBrowserWidth() === e && t.map(AppYalantis.Helpers.imageOnLoad)
        }
    }
        ...
        b = function() {
            ...
            i.each(function() {
                ...
                e.addClass(u + "-" + $(this).attr(d)), e.find("img").each(function() {
                    AppYalantis.Helpers.imageOnLoad($(this).attr("src"), t)
                })
            })
        },
        w = function() {
    ...
    return {
        init: function() {
            t = $("header.page-header"), e = $("body"), i = $("[" + d + "]"), n = $("[" + f + "]"), /(home|works)/.test(e.data("page")) || (b(), k(), $(window).resize(AppYalantis.Helpers.debounce(k, a)), $(window).scroll(P))
        },
        onScroll: P,
        onResize: AppYalantis.Helpers.debounce(k, a)
    }
    ...
    function t() {
        var t = s.closest(".form-checkbox"),
            e = t.find(".checkbox-required").is(":checked");
        if (e) $("#subscription-checkbox-error").remove();
        else if (!e && 0 === $("#subscription-checkbox-error").length) {
            var i = $('<div class="form-checkbox__msg"></div>').attr("id", "subscription-checkbox-error").text("To start getting news, you must agree to our Privacy Policy");
            t.append(i)
        }
    }
    var e = $("#form-subscribe"),
        i = $("body"),
        n = $(".form-field__input"),
        s = e.find(".checkbox-required"),
        o = $("#subscribe-complete"),
        r = $(".sender__subscribe");
    n.blur(function() {
        $(".remove-active").remove(), $(this).parent(n).removeClass("form-field--active"), 0 === $(this).val().length ? $(this).parent($(".form-field")).removeClass("form-field--filled") : $(this).parent($(".form-field")).addClass("form-field--filled")
    }), n.focus(function() {
        $(".remove-active").remove(), $(this).parent($(".form-field")).addClass("form-field--active")
        ...
        messages: {
            "subscription[email]": {
                ...
                correct_email: "Sorry, this email hasn't worked out. Make sure it's correct"
            }
        },
        focusInvalid: !1,
        errorClass: "form-field__msg",
        errorElement: "div",
        highlight: function(t) {
            $(t).closest(".form-field").addClass("form-field--error")
        },
        unhighlight: function(t) {
            $(t).closest(".form-field").removeClass("form-field--error")
        },
        errorPlacement: function(t, e) {
            $(e).closest(".form-field").append(t)
        }
    }), $.validator.addMethod("correct_email", function(t, e) {
        return this.optional(e) || null !== t.match(/\S+@\S+\.\S+/)
    }, "Enter correct email"), $.validator.addMethod("min_size_email", function(t, e) {
        return !!(this.optional(e) || t.replace(/\s/g, "").length >= 5)
    }, "Is too short (minimum is 2 characters)"), $.validator.addMethod("max_size_email", function(t, e) {
        return !(this.optional(e) || t.replace(/\s/g, "").length > 256)
    }, "Is too long (maximum is 256 characters)"), e.submit(function(n) {
        if (n.preventDefault(), t(), !($("#subscription-checkbox-error").length || $(".form-field--error").length)) {
            var a = $(this).find("input[name='subscription[email]']").val(),
                l = s.val();
            $.ajax({
                type: "POST",
                url: window.location.origin + "/subscriptions",
                data: {
                    privacy_policy_accepted: l,
                    email: a
                },
                success: function(t) {
                    t.success ? (r.css("display", "none"), o.css("display", "block"), setTimeout(function() {
                        i.css("overflow", "auto"), $("#modalButtonClose").trigger("click"), r.css("display", "block"), o.css("display", "none"), e.each(function() {
                            this.reset()
                        })
                    }, 2e3)) : $(".form-field.form-field.filled, .form-field.form-field--filled").addClass("form-field--error").append('<div id="subscription[email]-error" class="form-field__msg remove-active" style="">' + t.errors.email + "</div>")
                },
                error: function(t) {
                    console.log("error " + t)
                }
    ...
    function t() {
        e(), AppYalantis.FormCheckbox.init(), AppYalantis.BackgroundAdapter.init(), AppYalantis.DeviceAdapter.init(), AppYalantis.ScrollCatch.init(), n(), s(), /works/.test($("body").data("page")) && setTimeout(function() {
            window.scrollTo(0, 0)
        }, 2500)
    }
    ...
    function n() {
        /(tabletPortrait|tablet|mobile)/.test(AppYalantis.Helpers.getBrowserWidth()) && $(".section--top-company, .section--top-home").css("min-height", window.innerHeight)
    }
    ...
    new ScrollMagic.Scene({
        triggerElement: "[data-animation-anniversary]"
    }).on("enter", function() {
        $(".flow-layer").each(function() {
            $(this).addClass("animation")
        })
    }).addTo(i), new ScrollMagic.Scene({
        triggerElement: "[data-animation-anniversary]"
    }).on("enter", function() {
        $(".flow-layer").each(function() {
            $(this).addClass("animation")
    ...
    $(".recent-projects .project__desc, .concept__desc, .architect-scheme, .mails-list").each(function() {
        new ScrollMagic.Scene({
            triggerElement: this,
            triggerHook: .85
        }).setTween(TweenMax.from($(this), .5, {
            yPercent: 50,
            opacity: 0,
            ease: t
        })).reverse(!1).addTo(i)
    ...
    new ScrollMagic.Scene({
        triggerElement: ".list--process",
        triggerHook: "onEnter"
    }).setTween((new TimelineMax).staggerFrom(".list--process", .5, {
        yPercent: 25,
        opacity: 0,
        ease: t
    }).staggerFrom(".list--process .list__item", .15, {
        borderColor: "transparent",
        ease: t
    }, 0, .5)).reverse(!1).addTo(i);
    $(".section__control").each(function() {
        new ScrollMagic.Scene({
            triggerElement: this,
            triggerHook: .9
        }).setTween(TweenMax.from($(this), .5, {
    ...
    }), $(".team-list__item, .list--team .list__item, .knowledge-list__item, .knowledge-timeline__item, .quote, .description-list__item, .previews-list__item, .architect-scheme").each(function() {
        new ScrollMagic.Scene({
            triggerElement: this,
            triggerHook: "onEnter"
        }).setTween(TweenMax.from($(this), .5, {
    ...
    }), $(".list--services-blocks").each(function() {
        new ScrollMagic.Scene({
            triggerElement: this,
            triggerHook: "onEnter"
        }).setTween(TweenMax.from($(this), .5, {
        ...
        triggerHook: .85
    }).addTo(i).on("enter", function() {
        this.setTween(TweenMax.to(".loading", .5, {
            opacity: 0
        })).reverse(!1).addTo(i)
    });
    new ScrollMagic.Scene({
        triggerElement: ".list--competition",
        triggerHook: e
    }).setTween((new TimelineMax).staggerFrom(".list--competition .list__item", .5, {
        yPercent: 50,
        opacity: 0,
        ease: t
    }, .15)).reverse(!1).addTo(i), new ScrollMagic.Scene({
        triggerElement: ".list--models",
        triggerHook: e
    }).setTween((new TimelineMax).staggerFrom(".list--models .list__item", .5, {
        yPercent: 50,
        opacity: 0,
        ease: t
    }, .15).staggerFrom(".list--models .img", .5, {
        scale: 0,
        ease: t
    }, .15, .5)).reverse(!1).addTo(i);
    if ($(".list--divider .list__item").each(function() {
        new ScrollMagic.Scene({
            triggerElement: this,
            triggerHook: e
        }).setTween((new TimelineMax).from($(this).find(".img"), .5, {
            scale: 0,
            ease: t
        }, 0).from($(this).find(".divider"), .5, {
            scale: 0,
            ease: t
        }, 0).from($(this).find(".title"), .5, {
            y: 50,
            opacity: 0,
            ease: t
        }, .5).from($(this).find(".text, .list"), .5, {
            y: -50,
            opacity: 0,
            ease: t
        }, .5)).reverse(!1).addTo(i)
    }), $(".list--icons, .list--clients, .list--news, .list--devices, .list--cards, .list--previews, .list--graph, .list--tech-blocks").each(function() {
        new ScrollMagic.Scene({
            triggerElement: this,
            triggerHook: e
        }).setTween((new TimelineMax).staggerFrom($(this).find(".list__item"), .5, {
            yPercent: 50,
            opacity: 0,
            ease: t
        }, .15).staggerFrom($(this).find(".img"), .5, {
            scale: 0,
            ease: t
        }, .15, 0).staggerFrom($(this).find(".logo"), .5, {
            scale: 0,
            ease: t
        }, .15, 0)).reverse(!1).addTo(i)
    }), $(".index-list__item").each(function() {
        new ScrollMagic.Scene({
            triggerElement: this,
            triggerHook: e
        }).setTween((new TimelineMax).from($(this).find(".index-list__divider"), .5, {
            scale: 0,
            ease: t
        }).from($(this).find(".index-list__item-title"), .5, {
            yPercent: 50,
            opacity: 0,
            ease: t
        }, .5)).reverse(!1).addTo(i)
    }), $(".tech-scheme").each(function() {
        new ScrollMagic.Scene({
            triggerElement: this,
            triggerHook: e
        }).setClassToggle(this, "animated").reverse(!1).addTo(i)
    }), $(".graph").length) {
        var n = (new TimelineMax).to(".graph__line-inner", 1.4, {
            width: "100%",
            ease: t
        }).from(".graph__legend, .graph .gradient, .graph__dot", .5, {
            opacity: 0,
            ease: t
        }, 1.4);
        if ($(window).width() >= 768) new ScrollMagic.Scene({
            ...
            triggerHook: e
        }).setTween(n).reverse(!1).addTo(i)
    }
    if ($(".goals-scheme").length) {
        var s = $(".goals-scheme__item"),
            o = (new TimelineMax).from([s[0], s[2], s[4]], .6, {
                opacity: 0,
                ease: t
            }).from(s[0], .6, {
                left: "50%",
                ...
                xPercent: 50,
                ease: t
            }, .6).from(".goals-scheme__item-title", .4, {
                opacity: 0,
                ease: t
            }, 1.2).from([s[1], s[3]], .6, {
                scaleY: 0,
                opacity: 0,
                ease: t
            }, 1.2).staggerFrom($(s[1]).find(".goals-scheme__item-list li"), .4, {
                opacity: 0,
                xPercent: -30,
                ease: t
            }, .05, 1.8).staggerFrom($(s[3]).find(".goals-scheme__item-list li"), .4, {
                opacity: 0,
                xPercent: 30,
                ease: t
            }, .05, 1.8);
        if ($(window).width() >= 768) new ScrollMagic.Scene({
            triggerElement: ".goals-scheme",
            triggerHook: e
        }).setTween(o).reverse(!1).addTo(i)
    }
    if ($(".build-scheme").length) {
        var r = $(".build-scheme__block"),
            a = (new TimelineMax).from(r[0], .3, {
                opacity: 0,
                ease: t
            }).staggerFrom([r[1], r[2], r[3], r[4]], .2, {
                x: -200,
                opacity: 0,
                ease: t
            }, .1, .1).from(".build-scheme__title", .3, {
                opacity: 0,
                ease: t
            }, .7).from(".build-scheme__text", .3, {
                color: "transparent",
                ease: t
            }, .7);
        if ($(window).width() >= 768) new ScrollMagic.Scene({
            triggerElement: ".build-scheme",
            triggerHook: e,
            offset: 100
        }).setTween(a).reverse(!1).addTo(i)
    }
    if ($(".web-scheme").length) {
        var l = (new TimelineMax).from($(".web-scheme__circles"), .3, {
            opacity: 0,
            ease: Power1.easeOut
        }).from($(".circle--left"), .6, {
            transform: "rotate(87deg)",
            ease: Power1.easeOut
        }, .6).from($(".circle--right"), .6, {
            transform: "rotate(-87deg)",
            ease: Power1.easeOut
        }, .6).from($(".circle__part"), .1, {
            opacity: 0,
            ease: Power1.easeOut
        }, .7).from($(".circle__part span"), .3, {
            opacity: 0,
            ease: Power1.easeOut
        }, 1.2);
        if ($(window).width() >= 768) new ScrollMagic.Scene({
            triggerElement: ".web-scheme",
            triggerHook: e
        }).setTween(l).reverse(!1).addTo(i)
    }
    if ($(".design-scheme").length) {
        var h = $(".design-scheme__item"),
            c = (new TimelineMax).from($(".design-scheme__item"), .2, {
                opacity: 0,
                ease: t
            }).from(h[0], .5, {
                x: h[0].offsetWidth / 2,
                ...
                x: -h[2].offsetWidth / 2,
                ease: t
            }, .2).from(h.find(".arrow"), .2, {
                opacity: 0,
                ease: Power1.easeOut
            }, .7).from(h.find(".arrow"), .5, {
                width: 0,
                ease: Power1.easeOut
            }, .9).from($(".design-scheme .overlay, .design-scheme .title"), .5, {
                opacity: 0,
                ease: Power1.easeOut
            }, .9);
        if ($(window).width() >= 768) new ScrollMagic.Scene({
            triggerElement: ".design-scheme",
            triggerHook: e
        }).setTween(c).reverse(!1).addTo(i)
    }
    if ($(".devices-scheme").length) {
        var u = $(".devices-scheme__item"),
            d = (new TimelineMax).from([u[1], u[2]], .2, {
                opacity: 0,
                ease: t
            }).from(u[1], .5, {
                x: u[1].offsetWidth / 2,
                ...
                x: -u[3].offsetWidth,
                ease: t
            }, .7).from(".devices-scheme .img-overlay, .devices-scheme .title", .5, {
                opacity: 0,
                ease: t
            }, 1.4).from(".devices-scheme .img", .5, {
                scale: 0,
                ease: t
            }, 1.4);
        if ($(window).width() >= 768) new ScrollMagic.Scene({
            triggerElement: ".devices-scheme",
            triggerHook: e
        }).setTween(d).reverse(!1).addTo(i)
    }
    new ScrollMagic.Scene({
        triggerElement: ".section--bg-vishnu .concept__desc",
        triggerHook: e
    }).setTween((new TimelineMax).from(".section--bg-vishnu .section__bg-item:nth-child(1)", .5, {
        yPercent: 50,
        opacity: 0,
        ease: t
    }, .2).from(".section--bg-vishnu .section__bg-item:nth-child(2)", .8, {
        yPercent: 50,
        opacity: 0,
        ease: t
    }, .2)).reverse(!1).addTo(i);
    if ($(".concept__gallery").each(function() {
        function n() {
            var n = (new TimelineMax).from(o, .5, {
                yPercent: 50,
                opacity: 0,
                ease: t
            }).from(s[0], .5, {
        ...
        s.each(function() {
            ...
            t && (r++, AppYalantis.Helpers.imageOnLoad(t, function() {
                ++a === r && n()
            }))
        })
    }), $(".devices-scheme-android").length) {
        var p = $(".devices-scheme-android__item"),
            f = (new TimelineMax).from([p[0], p[1]], .2, {
                opacity: 0,
                ease: t
            }).from(p[0], .5, {
                x: p[0].offsetWidth,
                ...
                opacity: 0,
                ease: t
            }, .7).from(".devices-scheme-android .img-overlay, .devices-scheme-android .title", .5, {
                opacity: 0,
                ease: t
            }, .9).from(".devices-scheme-android .img", .5, {
                scale: 0,
                ease: t
            }, .9);
        if ($(window).width() >= 768) new ScrollMagic.Scene({
            triggerElement: ".devices-scheme-android",
            triggerHook: e
        }).setTween(f).reverse(!1).addTo(i)
    }
    if ($(".pm-scheme").length) {
        var m = $(".pm-scheme__item"),
            g = (new TimelineMax).from(m[1], .2, {
                opacity: 0,
                ease: t
            }).from($(m[1]).find(".title"), .2, {
                opacity: 0,
                ease: t
            }, .1).from($(m[1]).find(".img"), .2, {
                scale: 0,
                ease: t
            }, .1).from(m[0], .5, {
                opacity: 0,
                ...
                x: -m[2].offsetWidth / 2,
                ease: t
            }, .1).from($([m[0], m[2]]).find(".title"), .2, {
                opacity: 0,
                ease: t
            }, .5).from($([m[0], m[2]]).find(".img"), .2, {
                scale: 0,
                ease: t
            }, .5).from(m[3], .5, {
                opacity: 0,
                ...
                y: -m[5].offsetWidth / 2,
                ease: t
            }, .5).from($([m[3], m[5]]).find(".title"), .2, {
                opacity: 0,
                ease: t
            }, .9).from($([m[3], m[5]]).find(".img"), .2, {
                scale: 0,
                ease: t
            }, .9).from(m[4], .5, {
                opacity: 0,
                y: -m[4].offsetWidth / 2,
                ease: t
            }, .9).from($(m[4]).find(".title"), .2, {
                opacity: 0,
                ease: t
            }, 1.3).from($(m[4]).find(".img"), .2, {
                scale: 0,
                ease: t
            }, 1.3);
        if ($(window).width() >= 768) new ScrollMagic.Scene({
            triggerElement: ".pm-scheme",
            triggerHook: "onCenter"
        }).setTween(g).reverse(!1).addTo(i)
    }
    if ($(".ui-scheme").length) {
        var v = $(".ui-scheme__figure"),
            _ = (new TimelineMax).from($(".ui-scheme__device-wrap"), .4, {
                yPercent: 50,
                ease: t
            }).from($(".ui-scheme__figures-wrap"), .1, {
                opacity: 0,
                ease: t
            }, .4).from([v[0], v[1]], .5, {
                scaleX: .5,
        ...
        if ($(window).width() >= 768) new ScrollMagic.Scene({
            triggerElement: ".ui-scheme",
            triggerHook: e
        }).setTween(_).reverse(!1).addTo(i)
    }
    if ($(".qa-scheme").length) {
        var y = $(".qa-scheme__item"),
            b = (new TimelineMax).from(y[1], .2, {
                opacity: 0,
                ease: t
            }).from(".qa-scheme__item:nth-child(2) .img", .5, {
    ...
    if ($(".dev-scheme").length) {
        var k = $(".dev-scheme__item"),
            C = (new TimelineMax).from([k[0], k[2]], .8, {
                ...
                opacity: 0,
                ease: t
            }, .9).from(".dev-scheme .title, .dev-scheme .text", .8, {
                opacity: 0,
                yPercent: 50,
                ease: t
            }).from(".dev-scheme .code-editor", .8, {
                opacity: 0,
                ease: t
            }, 1.3).from(".dev-scheme .j-start-typer", .1, {
                opacity: 0,
                ease: t
            }).call(T, [], this, 2.1);
        if ($(window).width() >= 768) new ScrollMagic.Scene({
            triggerElement: ".dev-scheme",
            triggerHook: e
        }).setTween(C).reverse(!1).addTo(i)
    }
    $(".design-projects .section--project:nth-child(1)").each(function() {
        new ScrollMagic.Scene({
            triggerElement: this,
            triggerHook: "onCenter"
        }).setTween((new TimelineMax).from($(this).find(".project__img-wrap"), .5, {
            xPercent: -50,
            opacity: 0,
            ease: t
        }).from($(this).find(".project__desc"), .5, {
            xPercent: 50,
            opacity: 0,
            ease: t
        }, 0).from($(this).find(".balloons"), .5, {
            scale: 0,
            opacity: 0,
            ease: t
        }, .5).from($(this).find(".humans"), .5, {
            opacity: 0,
            ease: t
        }, 1)).reverse(!1).addTo(i)
    }), $(".design-projects .section--project:nth-child(2)").each(function() {
        new ScrollMagic.Scene({
            triggerElement: this,
            triggerHook: "onCenter"
        }).setTween((new TimelineMax).from($(this).find(".project__img-wrap"), .5, {
            ...
            opacity: 0,
            ease: t
        }, 0)).setClassToggle(".design-projects .section--project:nth-child(2) .balloons", "animated").reverse(!1).addTo(i)
    });
    new ScrollMagic.Scene({
        triggerElement: ".global-map__text",
        triggerHook: "onEnter"
    }).on("enter", function() {
        $(".global-map__map").addClass("global-map__map--active")
    }).on("leave", function() {
        $(".global-map__map").removeClass("global-map__map--active")
    }).addTo(i)
    ...
    function e() {
        f = $(".recent-projects"), m = $(".section"), g = $(".page-header"), i(), $(window).on("resize", AppYalantis.Helpers.debounce(r, 200))
    }
    ...
    function s(t) {
        return m.eq(t - 1 > 0 ? t - 1 : 0)
    }

    function o(t) {
        return void 0 !== t.data("duration") ? t.data("duration") : w
    }

    function r() {
        var t = $(window).scrollTop();
        k.reduce(function(e, i) {
            return t >= e.scrollOffset() && t <= i.scrollOffset() && e.trigger("enter"), i
        })
    }
    ...
    function h(t, e, i) {
        var n = t.key,
            s = t.color;
        u(n), i || TweenMax.to(f, e, {
            background: s,
            ease: _
        }), TweenMax.to(g, e, {
            background: s.replace(/1\)/g, "0.9)"),
            ease: _
        })
    }

    function c(t, e) {
        "hide-header" === t.data("scroll-type") && TweenMax.to(g, 0, {
            opacity: e ? 1 : 0,
            ease: _
        })
    }
    ...
    function u(t) {
        p(), document.body.classList.add(b + "-" + t)
    }

    function d() {
        return {
            "white-smoke": "linear-gradient(to left, rgba(245, 245, 245, 1), rgba(245, 245, 245, 1))",
            "ten-year-anniversary": "linear-gradient(to left, rgba(24, 24, 34, 1), rgba(24, 24, 34, 1))",
            "world-cleanup": "linear-gradient(to left, rgba(0, 133, 214, 1), rgba(0, 133, 214, 1))",
            booth: "linear-gradient(to left, #159980, #159980)",
            "half-cost-hotels": "linear-gradient(to left, #72ADFA, #045ACA)",
            kpmg: "linear-gradient(to left, rgba(1, 108, 185, 1), rgba(42, 123, 181, 1))",
            connecthome: "linear-gradient(to left, rgba(22, 24, 28, 1), rgba(22, 24, 28, 1))",
            ecuris: "linear-gradient(to left, rgba(34, 108, 166, 1), rgba(33, 135, 191, 1))",
            "brilliant-move": "linear-gradient(to left, rgba(180, 52, 246, 1), rgba(81, 78, 192, 1))",
            homesway: "linear-gradient(to left, rgba(44, 50, 57, 1), rgba(68, 73, 79, 1))",
            pogo: "linear-gradient(to left, rgba(237, 238, 214, 1), rgba(23, 199, 194, 1))",
            talos: "linear-gradient(to left, rgba(229, 229, 229, 1), rgba(229, 229, 229, 1))",
            fitnesscenter: "linear-gradient(to left, rgba(34, 192, 201, 1), rgba(55, 192, 182, 1))",
            jetjournal: "linear-gradient(to left, rgba(67, 131, 237, 1), rgba(67, 131, 237, 1))",
            vishnu: "linear-gradient(to left, rgba(218, 217, 255, 1), rgba(118, 129, 192, 1))",
            "move-app": "linear-gradient(to left, rgba(52, 159, 255, 1), rgba(52, 186, 254, 1))",
            bro: "linear-gradient(to left, rgba(47, 154, 219, 1), rgba(0, 133, 214, 1))",
            "workout-book": "linear-gradient(to left, rgba(38, 120, 101, 1), rgba(37, 149, 101, 1))",
            autoportal: "linear-gradient(to left, rgba(213, 86, 70, 1), rgba(204, 49, 29, 1))",
            snapbook: "linear-gradient(to left, rgba(64, 73, 88, 1), rgba(89, 96, 107, 1))",
            black: "linear-gradient(to left, rgba(22,24,28, 1), rgba(22,24,28, 1))",
            white: "linear-gradient(to left, rgba(255, 255, 255, 1), rgba(255, 255, 255, 1))",
            grey: "linear-gradient(to left, rgba(35,37,44, 1), rgba(35,37,44, 1))",
            growfit: "linear-gradient(to left, rgba(0,25,47, 1), rgba(0,25,47, 1))",
            mul: "linear-gradient(to left, rgba(46,57,92, 1), rgba(46,57,92, 1))"
        }
    }

    function p() {
        for (var t = document.body.classList, e = 0; e < t.length; e++) {
            var i = t[e];
            /scene--bg.+/.test(i) && document.body.classList.remove(i)
        }
    }
    ...
    $(document).on("click", ".section-ready-to-contact a", function() {
        ga.apply(this, e.concat(["conversion", "clicked on call to action", "clicked on call to action on page " + window.location.pathname]))
    }), $(document).on("click", ".section-segments-we-cover a", function() {
        ga.apply(this, e.concat(["engagement", "opened segment page", "opened segment page  - " + t($(this).attr("href")).pathname]))
    }), $(document).on("click", "#experiments a", function() {
        ga.apply(this, e.concat(["engagement", "opened experiment page", "opened experiment page  - " + t($(this).attr("href")).pathname]))
    }), $(document).on("click", "#related a", function() {
        ga.apply(this, e.concat(["engagement", "opened related posts", "opened related posts on page " + window.location.pathname + " direction - " + t($(this).attr("href")).pathname]))
    }), $(document).on("click", ".posts-related a", function() {
        ga.apply(this, e.concat(["engagement", "opened related posts on posts", "opened related posts on page " + window.location.pathname + " direction - " + t($(this).attr("href")).pathname]))
    }), $(document).on("click", ".posts-w a", function() {
        this.href.includes("yalantis.com/posts") && ga.apply(this, e.concat(["engagement", "opened relevant posts", "opened relevant posts on page " + window.location.pathname + " direction - " + t($(this).attr("href")).pathname]))
    }), $(document).on("submit", "#new_contact", function() {
        gtag && gtag("event", "sent form", {
            event_category: "conversion"
        })
    }), $(document).on("click", ".subscription-dialog", function() {
        ga.apply(this, e.concat(["engagement", "subscribe", "subscribe" + window.location.pathname]))
    }), $(document).on("complite-subscribe", function() {
        ga.apply(this, e.concat(["conversion", "subscribed", "subscribed" + window.location.pathname]))
    })
}), $(document).ready(function() {
    var t = .5,
        e = 100,
        ...
        n = !1,
        s = $("body");
    $("#headerButtonBurger").click(function() {
        n ? (s.css("overflow", "auto"), $(".main-nav").removeClass("main-nav--open"), $(".icon-burger").removeClass("icon-burger--active"), n = !n) : (TweenMax.staggerFromTo(".main-nav__list li", t, {
            opacity: 0,
            cycle: {
                x: [-e, e]
            }
        ...
        }, i), s.css("overflow", "hidden"), $(".main-nav").addClass("main-nav--open"), $(".icon-burger").addClass("icon-burger--active"), n = !n)
    }), $("#modalButtonClose").click(function() {
        s.css("overflow", "auto"), $(".modal").removeClass("modal--open")
    })
}), $(document).ready(function() {
    var t = $("body");
    $("#footerButton").click(function() {
        t.css("overflow", "hidden"), $(".modal").addClass("modal--open")
    }), $("#modalButtonClose").click(function() {
        t.css("overflow", "auto"), $(".modal").removeClass("modal--open")
    })
    ...
    var t = $(".page-loader"),
        ...
        n = 2500,
        s = 3500;
    t.addClass("page-loader--step-1"), setTimeout(function() {
        t.addClass("animate-point")
    }, e), setTimeout(function() {
        t.addClass("page-loader--step-3 hide")
    }, i), setTimeout(function() {
        $("body").css("overflow", "auto"), $(document).trigger("LOADER-FINISH")
    }, n), setTimeout(function() {
        t.removeClass("page-loader--step-3"), t.remove()
    }, s)
}), $(document).ready(function() {
    var t = $(".cookies"),
        e = $(".cookies .controls-list .btn");
    localStorage.getItem("userAgreedCookiesUsage") || t.addClass("cookies--show"), e.click(function() {
        t.removeClass("cookies--show"), localStorage.setItem("userAgreedCookiesUsage", !0)
    })
});
